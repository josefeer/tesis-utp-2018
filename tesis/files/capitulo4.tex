...
\input{files/cap4files/sections/protocir}

\input{files/cap4files/sections/firmware}

\input{files/cap4files/sections/appandroid}

\input{files/cap4files/sections/diseñoprototipo}
