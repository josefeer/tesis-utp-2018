...
\thispagestyle{plain}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=5cm, height=6cm]{isotech.jpg}
			\includegraphics[width=5cm, height=6cm]{termometroref.jpg}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=5cm, height=5cm]{celdaspuntofijo.jpg}
			\includegraphics[width=5cm, height=5cm]{supertermometro.jpg}
